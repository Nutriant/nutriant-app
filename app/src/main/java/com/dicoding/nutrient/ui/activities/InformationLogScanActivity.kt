...
class InformationLogScanActivity : AppCompatActivity() {
    ...
    private fun setupData() {
        binding.apply {
            ...
            edCaloriesTotal.setText(calor.toString())
        }
    }
...
//            Logic to save the history
        ...
        val textWatcher = object : TextWatcher {
            ...
            override fun afterTextChanged(p0: Editable?) {
                binding.btSaveHistory.setButtonInformationLog(
                    ...
                    etCaloriesResult = binding.edCaloriesTotal.text.toString()
                )
            }
        }
        ...
        binding.edCaloriesTotal.addTextChangedListener(textWatcher)
    }
